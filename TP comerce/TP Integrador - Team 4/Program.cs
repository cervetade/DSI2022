...
namespace ecommerce
{
    public class Program
    {
        ...
        public static void SeleccionarMetodoDePago()
        {
            ...
            Cliente cliente1 = new Cliente("Tadeo Cervellati", "42000111", "Cordoba");
            Cliente cliente2 = new Cliente("Federico Audizio", "22159753", "Santa Fe");
            ...
            do
            {
                ...
                switch (opcionPago)
                {
                    case 1:
                        ...
                        Cliente cliente3 = new Cliente("Cristian Nuñez", "35850255", "Morteros");
                    ...
                    case 2:
                        ...
                        Tarjeta tarjeta1 = new Tarjeta("123456789", "Tadeo Cervellati", 42000111, "Santander Rio", vencimiento1, 123, TipoTarjeta.Debito, cliente1);
                    ...
                    case 3:
                        Tarjeta tarjeta2 = new Tarjeta("987654321", "Fernando Cervellati", 18222333, "Macro", vencimiento2, 456, TipoTarjeta.Credito, cliente2);
